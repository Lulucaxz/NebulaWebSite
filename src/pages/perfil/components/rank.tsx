  ...
  return (
    <>
      ...
      >
        ...
        >
          <span style={{ marginRight: "200px" }}>{t('perfil.rank.profileColumn')}</span>
          <span>{t('perfil.rank.pointsColumn')}</span>
          <span style={{ position: "absolute", right: "25px" }}>
            {t('perfil.rank.positionColumn')}
          </span>
        </div>
