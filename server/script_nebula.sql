...
VALUES
  (1, 'Ana Souza', 'https://randomuser.me/api/portraits/women/1.jpg', 'Universo', 'Como ganhar mais pontos nas missões de observação?',
   'Estou parada na parte inferior do ranking. Registro sessões no diário, mas os pontos não sobem. Quais missões contam mais: mapas celestes, quizzes ou relatórios de campo?',
   JSON_ARRAY('Dúvida','Universo'), 24.0, 'esteUsuario', 'src/pages/forum/ImgComentarioTEMP/comentarioImg1.png'),
  (2, 'Bruno Lima', 'https://randomuser.me/api/portraits/men/2.jpg', 'Galáxia', 'Trilha ideal para iniciantes em astronomia observacional',
   'Quero focar em astronomia, mas não sei se começo por constelações, telescópios ou astrofotografia. Como vocês organizaram os estudos?',
   JSON_ARRAY('Dúvida','Galáxia','Conselho'), 38.0, 'outroUsuario', NULL),
  (3, 'Carla Dias', 'https://randomuser.me/api/portraits/women/3.jpg', 'Órbita', 'Material complementar sobre espectroscopia estelar',
   'Preciso de exercícios extras antes da prova sobre espectros e classificação estelar. Alguém indica livros ou simuladores?',
   JSON_ARRAY('Material','Órbita','Dúvida'), 17.0, 'outroUsuario', NULL),
  (4, 'Diego Alves', 'https://randomuser.me/api/portraits/men/4.jpg', 'Universo', 'Simulador de órbitas travando para mais alguém?',
   'O simulador do módulo de mecânica celeste congela desde ontem. Já limpei cache e troquei de navegador. Mais alguém?',
   JSON_ARRAY('Problema','Universo'), 42.0, 'outroUsuario', NULL),
  (5, 'Elisa Martins', 'https://randomuser.me/api/portraits/women/5.jpg', 'Galáxia', 'Organizando vigília para chuva de meteoros',
   'Estou montando um grupo no Discord para acompanhar a chuva Gemínidas com roteiro de observação. Quem quiser acompanhar, me chama!',
   JSON_ARRAY('Convite','Galáxia','Debate'), 56.0, 'outroUsuario', NULL),
  (6, 'Felipe Torres', 'https://randomuser.me/api/portraits/men/6.jpg', 'Órbita', 'Newtoniano ou refrator para primeira compra?',
   'Tenho base teórica e quero adquirir um telescópio. Vale mais investir em um newtoniano 150mm ou em um refrator pequeno com boa portabilidade?',
   JSON_ARRAY('Dúvida','Órbita','Conselho'), 31.0, 'outroUsuario', NULL),
  (7, 'Giovana Rocha', 'https://randomuser.me/api/portraits/women/7.jpg', 'Universo', 'Certificado do curso de astrofotografia não chegou',
   'Concluí o curso de astrofotografia avançada e o certificado não apareceu no painel. Quanto tempo costuma levar?',
   JSON_ARRAY('Problema','Universo'), 19.0, 'outroUsuario', NULL),
  (8, 'Henrique Melo', 'https://randomuser.me/api/portraits/men/8.jpg', 'Galáxia', 'Sugestão: alertas de eventos astronômicos',
   'Estudo à noite e sinto falta de notificações sobre conjunções e chuvas de meteoros. Seria ótimo configurar alertas.',
   JSON_ARRAY('Observação','Galáxia','Debate'), 89.0, 'outroUsuario', NULL),
  (9, 'Isabela Nunes', 'https://randomuser.me/api/portraits/women/9.jpg', 'Órbita', 'Dúvida sobre exercício de mapeamento das constelações',
   'Não consigo completar o exercício 7 do módulo 3 sem usar o aplicativo. Alguma dica para reconhecer padrões apenas com cartas celestes?',
   JSON_ARRAY('Dúvida','Órbita','Material'), 12.0, 'outroUsuario', NULL),
  (10, 'João Pedro', 'https://randomuser.me/api/portraits/men/10.jpg', 'Universo', 'Vale estudar exoplanetas antes de cosmologia?',
   'Já entendo fundamentos e quero planejar a trilha. Estudo detecção de exoplanetas antes ou depois dos tópicos de cosmologia?',
   JSON_ARRAY('Conselho','Universo','Debate'), 27.0, 'outroUsuario', NULL),
  (11, 'Karen Silva', 'https://randomuser.me/api/portraits/women/11.jpg', 'Galáxia', 'Live de dúvidas sobre telescópios ficará gravada?',
   'Perdi a última live sobre ajustes de telescópios. Fica gravada? Já existe data para a próxima?',
   JSON_ARRAY('Dúvida','Galáxia'), 33.0, 'outroUsuario', NULL),
  (12, 'Lucas Pinto', 'https://randomuser.me/api/portraits/men/12.jpg', 'Órbita', 'Compartilhando minha primeira astrofoto',
   'Registrei a Nebulosa de Órion com DSLR + 50mm e queria feedbacks sobre processamento e redução de ruído.',
...
VALUES
  (1, NULL, 2, 'Bruno Lima', 'https://randomuser.me/api/portraits/men/2.jpg', 'Órbita',
   'Você só ganha pontos quando marca as missões de observação como concluídas e envia os relatórios com tempo de exposição. Só assistir às aulas não conta.', NULL),
  (1, 1, 1, 'Ana Souza', 'https://randomuser.me/api/portraits/women/1.jpg', 'Universo',
   'Valeu pela dica! Vou registrar cada sessão no diário e anexar as fotos.', NULL),
  (2, NULL, 6, 'Felipe Torres', 'https://randomuser.me/api/portraits/men/6.jpg', 'Galáxia',
   'Comece aprendendo constelações a olho nu, depois parte para telescópios e só então astrofotografia.', NULL),
  (2, 3, 2, 'Bruno Lima', 'https://randomuser.me/api/portraits/men/2.jpg', 'Galáxia',
   'Show! Vou seguir essa sequência e focar primeiro no céu a olho nu.', NULL),
  (4, NULL, 11, 'Karen Silva', 'https://randomuser.me/api/portraits/women/11.jpg', 'Galáxia',
   'Também estou com o simulador travando. O suporte disse que já estão recalculando as trajetórias.', NULL),
  (5, NULL, 9, 'Isabela Nunes', 'https://randomuser.me/api/portraits/women/9.jpg', 'Órbita',
   'Quero participar da vigília! Pode mandar o roteiro e mapa de campo?', NULL),
  (6, NULL, 8, 'Henrique Melo', 'https://randomuser.me/api/portraits/men/8.jpg', 'Galáxia',
   'Começa pelo newtoniano. Ele reúne mais luz e sai mais em conta para observar nebulosas.', NULL),
  (6, 7, 6, 'Felipe Torres', 'https://randomuser.me/api/portraits/men/6.jpg', 'Órbita',
   'Perfeito, obrigado! Vou procurar um 150mm então.', NULL),
  (9, NULL, 5, 'Elisa Martins', 'https://randomuser.me/api/portraits/women/5.jpg', 'Galáxia',
   'Usa o método das linhas paralelas: traça retas imaginárias ligando estrelas-guia e compara com a carta até reconhecer o desenho.', NULL),
  (9, 9, 9, 'Isabela Nunes', 'https://randomuser.me/api/portraits/women/9.jpg', 'Órbita',
   'Agora entendi! Vou treinar com as cartas e depois volto com o resultado.', NULL);
...
CREATE TABLE IF NOT EXISTS `NEBULA`.`curso_modulo_custom` (
  ...
  `introducao_background` TEXT NOT NULL,
